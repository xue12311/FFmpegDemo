...
public final class SnackbarUtils {
     ...
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils} instance
     */
    public static com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils with(@NonNull final View view) {
        return new com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils(view);
    }
     ...
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils} instance
     */
    public com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils setMessage(@NonNull final CharSequence msg) {
        this.message = msg;
        return this;
    }
     ...
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils} instance
     */
    public com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils setMessageColor(@ColorInt final int color) {
     ...
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils} instance
     */
    public com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils setBgColor(@ColorInt final int color) {
        this.bgColor = color;
        return this;
    }
     ...
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils} instance
     */
    public com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils setBgResource(@DrawableRes final int bgResource) {
     ...
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils} instance
     */
    public com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils setDuration(@Duration final int duration) {
     ...
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils} instance
     */
    public com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils setAction(@NonNull final CharSequence text,
     ...
     */
    public com.zjx.appcommonlibrary.utils.utilcode.util.SnackbarUtils setBottomMargin(@IntRange(from = 1) final int bottomMargin) {
