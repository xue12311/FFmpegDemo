...
public class ClickUtils {
    ...
    private static class OnUtilsTouchListener implements View.OnTouchListener {
        ...
        private static class LazyHolder {
            private static final com.zjx.appcommonlibrary.utils.utilcode.util.ClickUtils.OnUtilsTouchListener INSTANCE = new com.zjx.appcommonlibrary.utils.utilcode.util.ClickUtils.OnUtilsTouchListener();
        }
    }
}
