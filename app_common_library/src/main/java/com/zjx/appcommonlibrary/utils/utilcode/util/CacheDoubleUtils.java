...
public final class CacheDoubleUtils implements CacheConstants {
    ...
    private static final Map<String, com.zjx.appcommonlibrary.utils.utilcode.util.CacheDoubleUtils> CACHE_MAP = new HashMap<>();

    private final CacheMemoryUtils mCacheMemoryUtils;
    private final CacheDiskUtils mCacheDiskUtils;

    /**
     * Return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.CacheDoubleUtils} instance.
     *
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.CacheDoubleUtils} instance
     */
    public static com.zjx.appcommonlibrary.utils.utilcode.util.CacheDoubleUtils getInstance() {
     ...
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.CacheDoubleUtils} instance
     */
    public static com.zjx.appcommonlibrary.utils.utilcode.util.CacheDoubleUtils getInstance(@NonNull final CacheMemoryUtils cacheMemoryUtils,
                                                                        @NonNull final CacheDiskUtils cacheDiskUtils) {
        final String cacheKey = cacheDiskUtils.toString() + "_" + cacheMemoryUtils.toString();
        com.zjx.appcommonlibrary.utils.utilcode.util.CacheDoubleUtils cache = CACHE_MAP.get(cacheKey);
        if (cache == null) {
            synchronized (com.zjx.appcommonlibrary.utils.utilcode.util.CacheDoubleUtils.class) {
                cache = CACHE_MAP.get(cacheKey);
                if (cache == null) {
                    cache = new com.zjx.appcommonlibrary.utils.utilcode.util.CacheDoubleUtils(cacheMemoryUtils, cacheDiskUtils);
