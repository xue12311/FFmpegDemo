...
import com.zjx.appcommonlibrary.utils.utilcode.util.ShellUtils;
...
public final class NetworkUtils {
     ...
     * @return type of network
     * <ul>
     * <li>{@link com.zjx.appcommonlibrary.utils.utilcode.util.NetworkUtils.NetworkType#NETWORK_ETHERNET} </li>
     * <li>{@link com.zjx.appcommonlibrary.utils.utilcode.util.NetworkUtils.NetworkType#NETWORK_WIFI    } </li>
     * <li>{@link com.zjx.appcommonlibrary.utils.utilcode.util.NetworkUtils.NetworkType#NETWORK_4G      } </li>
     * <li>{@link com.zjx.appcommonlibrary.utils.utilcode.util.NetworkUtils.NetworkType#NETWORK_3G      } </li>
     * <li>{@link com.zjx.appcommonlibrary.utils.utilcode.util.NetworkUtils.NetworkType#NETWORK_2G      } </li>
     * <li>{@link com.zjx.appcommonlibrary.utils.utilcode.util.NetworkUtils.NetworkType#NETWORK_UNKNOWN } </li>
     * <li>{@link com.zjx.appcommonlibrary.utils.utilcode.util.NetworkUtils.NetworkType#NETWORK_NO      } </li>
     * </ul>
     */
    @RequiresPermission(ACCESS_NETWORK_STATE)
        ...
        public void onReceive(Context context, Intent intent) {
            if (ConnectivityManager.CONNECTIVITY_ACTION.equals(intent.getAction())) {
                ...
                Utils.runOnUiThreadDelayed(new Runnable() {
                    @Override
                    public void run() {
                        NetworkType networkType = com.zjx.appcommonlibrary.utils.utilcode.util.NetworkUtils.getNetworkType();
