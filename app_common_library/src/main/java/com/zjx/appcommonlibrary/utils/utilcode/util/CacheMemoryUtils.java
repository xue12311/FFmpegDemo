...
public final class CacheMemoryUtils implements CacheConstants {
    ...
    private static final Map<String, com.zjx.appcommonlibrary.utils.utilcode.util.CacheMemoryUtils> CACHE_MAP = new HashMap<>();

    private final String mCacheKey;
    private final LruCache<String, CacheValue> mMemoryCache;

    /**
     * Return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.CacheMemoryUtils} instance.
     *
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.CacheMemoryUtils} instance
     */
    public static com.zjx.appcommonlibrary.utils.utilcode.util.CacheMemoryUtils getInstance() {
     ...
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.CacheMemoryUtils} instance
     */
    public static com.zjx.appcommonlibrary.utils.utilcode.util.CacheMemoryUtils getInstance(final int maxCount) {
     ...
     * @return the single {@link com.zjx.appcommonlibrary.utils.utilcode.util.CacheMemoryUtils} instance
     */
    public static com.zjx.appcommonlibrary.utils.utilcode.util.CacheMemoryUtils getInstance(final String cacheKey, final int maxCount) {
        com.zjx.appcommonlibrary.utils.utilcode.util.CacheMemoryUtils cache = CACHE_MAP.get(cacheKey);
        if (cache == null) {
            synchronized (com.zjx.appcommonlibrary.utils.utilcode.util.CacheMemoryUtils.class) {
                cache = CACHE_MAP.get(cacheKey);
                if (cache == null) {
                    cache = new com.zjx.appcommonlibrary.utils.utilcode.util.CacheMemoryUtils(cacheKey, new LruCache<String, CacheValue>(maxCount));
